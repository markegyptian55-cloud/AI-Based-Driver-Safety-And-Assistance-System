...
>(
  (
    ...
    // Route changes are the single source of truth for dismissing the mobile
    // drawer. This also covers keyboard navigation, browser history and links
    // added later that forget to attach an onClick handler.
    React.useEffect(() => {
